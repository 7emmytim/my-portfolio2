                ...
                <div className='space-y-8'>
                    ...
                    <div className=''>
                        <motion.h3
                            ...
                            initial='hidden'
                            animate='show'
                            className='text-black dark:text-white text-2xl lg:text-3xl xl:text-4xl font-bold'>
                        ...
                        <h3 className='text-black dark:text-white blur-sm hover:blur-0 text-xl lg:text-2xl xl:text-3xl font-bold'>{'<Self-taught Frontend Dev />;'}</h3>
                    </div>
